...
async function renderMastersList() {
  ...
  const params = { categoryId: App.state.selectedCategory, pageSize: 30 };
  ...
  if (filter === 'near') {
    try {
      ...
      // Joylashuv berilmasa, oddiy ro'yxat ko'rsatiladi
    }
  }
  ...
  return `
    <div class="master-card master-card-wide" onclick="openMasterProfile('${m.id}')">
      ...
      <div style="flex:1; min-width:0;">
        ...
        <div class="master-meta">${m.experienceYears} yil tajriba</div>
    ...
    <div class="profile-hero">
      ...
      <div class="profile-hero-info">
        ...
        <div style="display:flex; align-items:center; gap:8px; font-size:13.5px;">
          <span>${m.category ? m.category.name : ''}</span>
